...
// Font Dropdown
var lblFont				= "<option value=\"\" selected=\"selected\">字体</option>";
...
var lblnon_designMode	= '使用字体编辑器, 需要 <a href="http://www.mozilla.org/" target="_blank">Mozilla 1.3+或以上版本</a> 浏览器 (eg, <a href="http://www.getfirefox.com/" target="_blank">Firefox</a>), <a href="http://www.apple.com/safari/download/" target="_blank">Safari 1.3+</a>, <a href="http://www.opera.com/" target="_blank">Opera 9+</a>  或者 <a href="http://www.microsoft.com/windows/products/winfamily/ie/default.mspx" target="_blank">MS IE5+或以上版本</a> (Windows) . IE5(Mac) 浏览器不支持当前编辑器，所有字体必须是HTML编码.';
